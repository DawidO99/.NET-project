...
namespace CarWorkshopManagementSystem.Controllers
{
    ...
    public class ServiceOrdersController : Controller
    {
        ...
        public ServiceOrdersController(IServiceOrderService orderService, IVehicleService vehicleService, UserManager<AppUser> userManager)
        {
        ...
        {
            // Przygotowujemy dane dla dropdownów w formularzu
        ...
        {
            // Usuwamy błąd walidacji dla Vehicle, bo nie jest przesyłane z formularza
            ...
            // Jeśli walidacja się nie powiodła, musimy ponownie załadować dane do dropdownów
