...
namespace CarWorkshopManagementSystem.Data.Migrations
{
    ...
    [Migration("20250621155157_AddEditDeleteVehicleActionsAndCorrectServiceOrderDate")]
    partial class AddEditDeleteVehicleActionsAndCorrectServiceOrderDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarWorkshopManagementSystem.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("CarWorkshopManagementSystem.Models.Comment", b =>
                {
                    b.HasOne("CarWorkshopManagementSystem.Models.AppUser", "Author")
                        .WithMany("Comments")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarWorkshopManagementSystem.Models.ServiceOrder", "Order")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("CarWorkshopManagementSystem.Models.ServiceOrder", b =>
                {
                    b.HasOne("CarWorkshopManagementSystem.Models.AppUser", "AssignedMechanic")
            ...
            modelBuilder.Entity("CarWorkshopManagementSystem.Models.UsedPart", b =>
                {
                    b.HasOne("CarWorkshopManagementSystem.Models.Part", "Part")
                        .WithMany()
                        .HasForeignKey("PartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarWorkshopManagementSystem.Models.ServiceTask", "Task")
                        .WithMany("UsedParts")
            ...
            modelBuilder.Entity("CarWorkshopManagementSystem.Models.Vehicle", b =>
                {
                    b.HasOne("CarWorkshopManagementSystem.Models.Customer", "Customer")
                        .WithMany("Vehicles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CarWorkshopManagementSystem.Models.AppUser", null)
                        .WithMany()
